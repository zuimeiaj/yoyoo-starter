...
export default class ViewResizable extends NoZoomTransform{
    ...
    componentDidMount(){
        ...
        let cx, cy, startAngle, currentAngle = 0, rotation = 0
        //rotation
    ...
    startResizeHandler = ()=>{
        ...
        let type, rect, matrix = null, opposite = null, startAngle = 0, pressAngle = 0, currentRatio = 0,
            parentRect = {}
    ...
    applyToDom = ()=>{
        ...
        let ox = x + width / 2, oy = y + height / 2;
