    ...
    return (
      ...
      >
        ...
        <div className={'item'}>
          ...
          <div className={'control-items'}></div>
        </div>
      </InspectorCard>
    );
  }
...
export class FontIconEditor extends InspectorText {
  ...
  render() {
    return (
      <InspectorCard
        className={'inspector-text inspector-font'}
        title={
          <Fragment>
            <Icon type={'jianyi'} />
            图标
      ...
      >
        <div className={'item'}>
          ...
          <div className={'control-items'}>
            <ButtonGroup onClick={(value) => this.onChange('style', value)} ref={'fontStyle'} multiple={true}>
              <Button key={'bold'}>
                <Icon type={'cuti'} />
              </Button>
              <Button key={'italic'}>
        ...
        <div className={'drop-icons'} ref={'signle'}>
          <div className={'item'}>
            ...
            <div className={'control-items drop-icon'}>
              <Dropable onDrop={(data) => this.handleIconDrop(data, 'data')}>拖拽新图标到此</Dropable>
              【<PresetIcon ref={'icon'} />】
            </div>
          </div>
        </div>
        <div className={'drop-icons'} ref={'toggle'}>
          <div className={'item'}>
            ...
            <div className={'control-items drop-icon'}>
              <Dropable onDrop={(data) => this.handleIconDrop(data, 'iconSelected')}>拖拽新图标到此</Dropable>
          ...
          <div className={'item'}>
            ...
            <div className={'control-items drop-icon'}>
              <Dropable onDrop={(data) => this.handleIconDrop(data, 'iconUnselected')}>拖拽新图标到此</Dropable>
