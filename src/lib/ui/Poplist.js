    ...
    render(){
        ...
        return (
            <span onMouseLeave={this.handleMouseLeave} onMouseEnter={this.handleToggleDisplay} className={'aj-poplist'}>
                <span ref={'emitter'}
                      className={'aj-poplist_emitter'}>{children}</span>
                {this.state.show && (
                    <div
                        style={{top : this.state.top}}
                        className={'aj-poplist_list'}>
                        {overlay}
                    </div>
                )}
            </span>
...
export class Menu extends React.Component {
    ...
    handleClick = (e) =>{
        ...
        if (target) {
            ...
            if (disabled !== 'true')
                this.props.onClick(target.dataset.id)
        }
...
export class MenuItem extends React.PureComponent {
    ...
    render(){
        ...
        return <div data-disabled={disabled} data-id={action} className={this.getClassName()}>
