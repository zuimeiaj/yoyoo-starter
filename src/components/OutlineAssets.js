...
export default class OutlineAssets extends CacheState {
    ...
    render(){
        return (<FileDrop onChange={this.handleChange} className="root-layout-side-assets">
            
            <div style={{padding : 15,display:'flex'}}><Search placeholder={'资源名称'} onSearch={this.handleSearch}/></div>
            ...
            </div>
            {
                this.state.list.map((item, index) =>{
                    return (<WrapperAssetsItem handleDelete={this.handleDelete}
            ...
            <div style={{padding : 10}}><Button block className={'load-more'} onClick={this.loadMore}>加载更多</Button>
            </div>}
