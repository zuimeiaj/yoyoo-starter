            ...
            <div className={'header_preferences'}>
                ...
                <div className={'preferences-content'}>
                    <div className={'preferences-form-item'}>
                        <label>触发距离</label>
                        <NumberInput onChange={(v)=>this.handleChange('autoAlign', v)} max={5} min={0}
                                     defaultValue={config.autoAlign}/>
                        <div className={'preferences-form-item_extra'}>
                            拖拽的组件与目标组件距离小于此值时，将自动与目标组件对齐
                        </div>
                    </div>
                </div>
